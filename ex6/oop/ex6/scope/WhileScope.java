 ...
 */
public class WhileScope extends StipulationScope {
     ...
     */
    public WhileScope(Map<String, Variable> innerVars, Map<String, Variable> outerVars, Map<String, Method>
            innerMethods){
        super(innerVars, outerVars, innerMethods);
        this.pattern = Regex.WHILE_REGEX;
    }
}